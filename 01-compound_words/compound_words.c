...
char* read_line(int);
int in_hash_table(word_node *[], char *, unsigned);
void identify_compound_words(char *[], word_node *[], int);
...
void 
identify_compound_words(char *words[], word_node *hash_table[], 
                        int total_words) 
{
    int i, j;
    unsigned len;
...
int 
in_hash_table(word_node *hash_table[], char *find, 
              unsigned find_len) 
{
    unsigned word_code;
    word_node *wordptr;
