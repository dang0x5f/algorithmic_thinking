...
int read_tree(node *[], int);
int score_one(node *, int);
void score_all(node **, int, int);
int compare(const void*, const void*);
void output_info(node *[], int);
...
int 
read_tree(node *nodes[], int num_lines)
{
...
void
score_all(node **nodes, int num_nodes, int d)
{
    int i;
    for(i = 0; i < num_nodes; i++)
...
void 
output_info(node *nodes[], int num_nodes)
{
    int i = 0;
